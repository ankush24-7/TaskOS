...
const Timeline = () => {
  ...
  return (
    <div className="relative w-full flex flex-col max-h-[90%] rounded-2xl lg:max-h-130 bg-stone-900/80">
      <div className="flex pt-1 pl-8.25 rounded-t-2xl bg-prim-black">
        {renderHeader()}
      </div>
