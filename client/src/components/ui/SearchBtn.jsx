  ...
  return (
    <form className="relative group flex-grow" onSubmit={(e) => e.preventDefault()}>
      ...
      <input
        ...
        className="w-full rounded-xl pl-10 pr-2 py-1.5 bg-transparent ring-[1.25px] focus:outline-none ring-white text-white placeholder:text-gray-400 focus:placeholder:text-gray-400 hover:bg-prim-black focus:bg-prim-black"
      />
    </form>
  );
};
